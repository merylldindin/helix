...
To invoke a skill, read `.claude/skills/{name}/SKILL.md` and follow the instructions exactly. `.agents/skills` should remain a symlink to `.claude/skills` for agent compatibility.
...
- `CLAUDE.md` - Canonical project-level agent instructions
- `.claude/rules/` - Coding conventions and content system guidance
- `.claude/skills/` - Canonical skill definitions
- `.agents/skills` - Symlink to `.claude/skills` for agent discovery
